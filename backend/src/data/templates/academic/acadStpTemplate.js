const section = (sectionNumber, title, isRequired, validationTag, displayOrder) => ({
  sectionNumber,
  title,
  description: `This section explains the ${title.toLowerCase()} for the academic test plan.`,
  guidanceText: `Write clear academic testing details for the ${title.toLowerCase()}.`,
  exampleText: null,
...
module.exports = {
  name: "Academic Software Test Plan",
  code: "ACAD_STP",
  profileCode: "ACADEMIC_PROJECT",
  documentType: "STP",
  description: "Defines test scope, items, features, approach, environment, test data, test cases, risks, roles, and traceability.",
  recommendedFor: "Academic software projects that need a structured testing and evaluation plan.",
  displayOrder: 4,
  sections: [
    ...
    section("13", "Testing Risks and Contingencies", true, "TEST_RISKS_CONTINGENCIES", 20),
